...
struct DetailResponseDTO: Decodable {
    ...
    func toDomain() throws -> DetailInfoEntity {
        ...
        return .init(headerInfo: headerInfo, ratingInfo: ratingEntity, subInfo: subInfo, releaseInfo: releaseEntity, descriptionInfo: descriptionEntity, age: detailInfo.trackContentRating, languageList: detailInfo.languageCodesISO2A)
    }
}
